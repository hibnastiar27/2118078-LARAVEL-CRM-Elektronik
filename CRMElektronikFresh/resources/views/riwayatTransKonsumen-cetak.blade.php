...
<head>
  <title>Report Transaksi Konsumen</title>
...
<body>
  ...
  <div class="box">
    ...
    <div class="box-item text-right">
      <p style="font-size: 1.5rem; font-weight: bold">Data Riwayat Transaksi Konsumen</p>
      ...
      @foreach ($transaksi as $item)
        @if ($item->user->role == 'konsumen')
          <tr>
            ...
            <td>{{ $item->tanggal }}</td>
            <td>
              <span class="badge badge-danger mx-2">{{ $item->user->role }}</span>
