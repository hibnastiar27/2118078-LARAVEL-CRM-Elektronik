...
<head>
  <title>Report Data Transaksi</title>
  ...
  <div class="box">
    <div class="box-item float-left">
      <p style="font-size: 1.5rem; font-weight: bold">
        <span class="primary px-3 py-2 rounded-circle text-white">CRM</span>
        ELEKTRONIK
      </p>
    </div>
    <div class="box-item text-right">
      <p style="font-size: 1.5rem; font-weight: bold">Data Transaksi</p>
